...
*/@font-face{font-family:"Ionicons";src:url("../fonts/ionicons/fonts/ionicons580c.eot?v=4.0.0-19");src:url("../fonts/ionicons/fonts/ionicons580c.eot?v=4.0.0-19#iefix") format("embedded-opentype"),url("../fonts/ionicons/fonts/ionicons580c.woff2?v=4.0.0-19") format("woff2"),url("../fonts/ionicons/fonts/ionicons580c.woff?v=4.0.0-19") format("woff"),url("../fonts/ionicons/fonts/ionicons580c.ttf?v=4.0.0-19") format("truetype"),url("../fonts/ionicons/fonts/ionicons580c.svg?v=4.0.0-19#Ionicons") format("svg");font-weight:normal;font-style:normal}.ionicons,.ion-ios-arrow-forward:before,.ion-ios-arrow-round-forward:before,.ion-ios-checkmark-circle:before,.ion-md-arrow-back:before{display:inline-block;font-family:"Ionicons";speak:none;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;text-rendering:auto;line-height:1;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.ion-ios-arrow-forward:before{content:"\f3d1"}.ion-ios-arrow-round-forward:before{content:"\f119"}.ion-ios-checkmark-circle:before{content:"\f14a"}.ion-md-arrow-back:before{content:"\f27d"}
	/*
...
.no-gutters {
 ...
 .col, .col-md-2, .col-md-3, .col-md-4, .col-md-5, .col-md-6, .col-md-7, .col-md-8, .col-md-9, .col-md-10, .col-md-12, .col-md, .col-lg-3, .col-lg-4, .col-lg-6, .col-lg-8, .col-lg-10, .col-xl-4 {
  position: relative;
  width: 100%;
  padding-right: 15px;
  padding-left: 15px; }
...
.sermon-wrap {
  ...
  .sermon-wrap .img {
    ...
    .sermon-wrap .img .text-content {
      z-index: 1; }
      .sermon-wrap .img .text-content span {
        text-transform: uppercase;
        letter-spacing: 4px;
        font-size: 12px;
        color: #fff; }
      .sermon-wrap .img .text-content h3 {
        font-family: "Great Vibes", cursive;
        color: #fff; }
...
.donated-intro {
  ...
  .donated-intro h2 {
    ...
    font-weight: 800;
    color: #fff; }
    .donated-intro h2 span {
      color: #ffd615; }
    .donated-intro h2 strong {
      color: #ffd615; }
  ...
  .cause-entry .text {
    ...
    .cause-entry .text h3 {
      ...
      .cause-entry .text h3 a {
        color: #000000; }
    .cause-entry .text .donate {
      display: block;
      margin-bottom: 10px; }
      .cause-entry .text .donate .price {
        font-weight: 700;
        font-size: 12px; }
      .cause-entry .text .donate .target-goal {
        font-size: 12px; }
...
.progress-bar {
  ...
  .progress-bar:after {
    ...
    border-color: transparent transparent #ffd615 transparent; }
  .progress-bar span {
    position: absolute;
    top: -22px;
    right: -5px;
  ...
  .ftco-about-section .one-half {
    ...
    @media (max-width: 767.98px) {
      .ftco-about-section .one-half {
        ...
        margin-left: 30px; } }
    @media (min-width: 1200px) {
      .ftco-about-section .one-half.half-text {
        position: absolute;
        top: 0;
        left: 0;
        bottom: 0;
        ...
        width: 1140px;
        margin: 0 auto; }
        .ftco-about-section .one-half.half-text .text-inner {
          max-width: 50%; } }
    .ftco-about-section .one-half.half-text .text-inner h3.heading {
      ...
      .ftco-about-section .one-half.half-text .text-inner h3.heading span {
        color: #ffd615; }
    .ftco-about-section .one-half.half-text .text-inner ul {
      margin: 0;
      padding: 0; }
      .ftco-about-section .one-half.half-text .text-inner ul li {
        list-style: none; }
        .ftco-about-section .one-half.half-text .text-inner ul li span {
          color: #ffd615; }
